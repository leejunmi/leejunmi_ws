...
class Metaclass_NumNum(type):
    """Metaclass of message 'NumNum'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('number')
        except ImportError:
            import logging
            import traceback
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__num_num
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__num_num
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__num_num
            cls._TYPE_SUPPORT = module.type_support_msg__msg__num_num
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__num_num
...
class NumNum(metaclass=Metaclass_NumNum):
    """Message class 'NumNum'."""
