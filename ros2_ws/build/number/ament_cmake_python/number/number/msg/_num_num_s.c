...
bool number__msg__num_num__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("number.msg._num_num.NumNum", full_classname_dest, 26) == 0);
  }
  number__msg__NumNum * ros_message = _ros_message;
  {  // a
...
{
  /* NOTE(esteve): Call constructor of NumNum */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("number.msg._num_num");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NumNum");
