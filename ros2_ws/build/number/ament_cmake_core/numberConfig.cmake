...
if(_number_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED number_FOUND)
    # explicitly set it to FALSE, otherwise CMake will set it to TRUE
    set(number_FOUND FALSE)
  elseif(NOT number_FOUND)
    # use separate condition to avoid uninitialized variable warning
    set(number_FOUND FALSE)
  endif()
  return()
endif()
set(_number_CONFIG_INCLUDED TRUE)

# output package information
if(NOT number_FIND_QUIETLY)
  message(STATUS "Found number: 0.0.0 (${number_DIR})")
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "Package 'number' is deprecated")
  # append custom deprecation text if available
  if(NOT "" STREQUAL "TRUE")
    set(_msg "${_msg} ()")
  endif()
  # optionally quiet the deprecation message
  if(NOT ${number_DEPRECATED_QUIET})
    message(DEPRECATION "${_msg}")
  endif()
endif()

# flag package as ament-based to distinguish it after being find_package()-ed
set(number_FOUND_AMENT_PACKAGE TRUE)
