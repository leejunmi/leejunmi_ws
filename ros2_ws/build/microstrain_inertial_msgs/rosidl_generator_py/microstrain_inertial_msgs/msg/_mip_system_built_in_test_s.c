...
bool microstrain_inertial_msgs__msg__mip_system_built_in_test__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("microstrain_inertial_msgs.msg._mip_system_built_in_test.MipSystemBuiltInTest", full_classname_dest, 76) == 0);
  }
  microstrain_inertial_msgs__msg__MipSystemBuiltInTest * ros_message = _ros_message;
  {  // header
  ...
  {  // result
    ...
    }
    {
      ...
      Py_ssize_t size = 16;
      uint8_t * dest = ros_message->result;
...
{
  /* NOTE(esteve): Call constructor of MipSystemBuiltInTest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("microstrain_inertial_msgs.msg._mip_system_built_in_test");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MipSystemBuiltInTest");
  ...
  {  // result
    ...
    uint8_t * src = &(ros_message->result[0]);
