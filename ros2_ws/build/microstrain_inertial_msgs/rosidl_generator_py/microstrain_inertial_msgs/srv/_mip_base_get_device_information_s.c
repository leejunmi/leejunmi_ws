...
bool microstrain_inertial_msgs__srv__mip_base_get_device_information__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("microstrain_inertial_msgs.srv._mip_base_get_device_information.MipBaseGetDeviceInformation_Request", full_classname_dest, 98) == 0);
  }
  microstrain_inertial_msgs__srv__MipBaseGetDeviceInformation_Request * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of MipBaseGetDeviceInformation_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("microstrain_inertial_msgs.srv._mip_base_get_device_information");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MipBaseGetDeviceInformation_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool microstrain_inertial_msgs__srv__mip_base_get_device_information__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("microstrain_inertial_msgs.srv._mip_base_get_device_information.MipBaseGetDeviceInformation_Response", full_classname_dest, 99) == 0);
  }
  microstrain_inertial_msgs__srv__MipBaseGetDeviceInformation_Response * ros_message = _ros_message;
  {  // device_info
...
{
  /* NOTE(esteve): Call constructor of MipBaseGetDeviceInformation_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("microstrain_inertial_msgs.srv._mip_base_get_device_information");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MipBaseGetDeviceInformation_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
