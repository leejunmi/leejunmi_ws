...
#include "microstrain_inertial_msgs/msg/detail/mip_filter_gnss_dual_antenna_status__rosidl_typesupport_fastrtps_c.h"
...
#include "microstrain_inertial_msgs/msg/detail/mip_filter_gnss_dual_antenna_status_status_flags__functions.h"  // status_flags
...
using _MipFilterGnssDualAntennaStatus__ros_msg_type = microstrain_inertial_msgs__msg__MipFilterGnssDualAntennaStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MipFilterGnssDualAntennaStatus__ros_msg_type * ros_message = static_cast<const _MipFilterGnssDualAntennaStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: status_flags
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, microstrain_inertial_msgs, msg, MipFilterGnssDualAntennaStatusStatusFlags
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _MipFilterGnssDualAntennaStatus__ros_msg_type * ros_message = static_cast<_MipFilterGnssDualAntennaStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_microstrain_inertial_msgs__msg__MipFilterGnssDualAntennaStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MipFilterGnssDualAntennaStatus__ros_msg_type * ros_message = static_cast<const _MipFilterGnssDualAntennaStatus__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_microstrain_inertial_msgs__msg__MipFilterGnssDualAntennaStatusStatusFlags(
...
static uint32_t _MipFilterGnssDualAntennaStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_microstrain_inertial_msgs__msg__MipFilterGnssDualAntennaStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_microstrain_inertial_msgs
size_t max_serialized_size_microstrain_inertial_msgs__msg__MipFilterGnssDualAntennaStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: status_flags
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_microstrain_inertial_msgs__msg__MipFilterGnssDualAntennaStatusStatusFlags(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = microstrain_inertial_msgs__msg__MipFilterGnssDualAntennaStatus;
    is_plain =
      (
...
static size_t _MipFilterGnssDualAntennaStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_microstrain_inertial_msgs__msg__MipFilterGnssDualAntennaStatus(
...
static message_type_support_callbacks_t __callbacks_MipFilterGnssDualAntennaStatus = {
...
static rosidl_message_type_support_t _MipFilterGnssDualAntennaStatus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MipFilterGnssDualAntennaStatus,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, microstrain_inertial_msgs, msg, MipFilterGnssDualAntennaStatus)() {
  return &_MipFilterGnssDualAntennaStatus__type_support;
}
