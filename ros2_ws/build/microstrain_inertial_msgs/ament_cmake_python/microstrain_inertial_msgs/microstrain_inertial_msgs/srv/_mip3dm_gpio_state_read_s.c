...
bool microstrain_inertial_msgs__srv__mip3dm_gpio_state_read__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("microstrain_inertial_msgs.srv._mip3dm_gpio_state_read.Mip3dmGpioStateRead_Request", full_classname_dest, 81) == 0);
  }
  microstrain_inertial_msgs__srv__Mip3dmGpioStateRead_Request * ros_message = _ros_message;
  {  // pin
...
{
  /* NOTE(esteve): Call constructor of Mip3dmGpioStateRead_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("microstrain_inertial_msgs.srv._mip3dm_gpio_state_read");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Mip3dmGpioStateRead_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool microstrain_inertial_msgs__srv__mip3dm_gpio_state_read__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("microstrain_inertial_msgs.srv._mip3dm_gpio_state_read.Mip3dmGpioStateRead_Response", full_classname_dest, 82) == 0);
  }
  microstrain_inertial_msgs__srv__Mip3dmGpioStateRead_Response * ros_message = _ros_message;
  {  // pin
    PyObject * field = PyObject_GetAttrString(_pymsg, "pin");
    if (!field) {
      return false;
...
{
  /* NOTE(esteve): Call constructor of Mip3dmGpioStateRead_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("microstrain_inertial_msgs.srv._mip3dm_gpio_state_read");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Mip3dmGpioStateRead_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
