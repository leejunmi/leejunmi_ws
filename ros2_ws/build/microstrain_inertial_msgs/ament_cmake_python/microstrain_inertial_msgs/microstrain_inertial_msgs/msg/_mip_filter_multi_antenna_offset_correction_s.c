...
bool microstrain_inertial_msgs__msg__mip_filter_multi_antenna_offset_correction__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("microstrain_inertial_msgs.msg._mip_filter_multi_antenna_offset_correction.MipFilterMultiAntennaOffsetCorrection", full_classname_dest, 111) == 0);
  }
  microstrain_inertial_msgs__msg__MipFilterMultiAntennaOffsetCorrection * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of MipFilterMultiAntennaOffsetCorrection */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("microstrain_inertial_msgs.msg._mip_filter_multi_antenna_offset_correction");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MipFilterMultiAntennaOffsetCorrection");
  ...
  {  // offset
    ...
    float * src = &(ros_message->offset[0]);
