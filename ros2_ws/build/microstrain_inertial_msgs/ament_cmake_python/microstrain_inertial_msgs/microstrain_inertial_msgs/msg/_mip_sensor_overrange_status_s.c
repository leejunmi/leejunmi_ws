...
bool microstrain_inertial_msgs__msg__mip_sensor_overrange_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("microstrain_inertial_msgs.msg._mip_sensor_overrange_status.MipSensorOverrangeStatus", full_classname_dest, 83) == 0);
  }
  microstrain_inertial_msgs__msg__MipSensorOverrangeStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // status
    ...
    if (!microstrain_inertial_msgs__msg__mip_sensor_overrange_status_status__convert_from_py(field, &ros_message->status)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of MipSensorOverrangeStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("microstrain_inertial_msgs.msg._mip_sensor_overrange_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MipSensorOverrangeStatus");
  ...
  {  // status
    PyObject * field = NULL;
    field = microstrain_inertial_msgs__msg__mip_sensor_overrange_status_status__convert_to_py(&ros_message->status);
    if (!field) {
      return NULL;
    }
    {
