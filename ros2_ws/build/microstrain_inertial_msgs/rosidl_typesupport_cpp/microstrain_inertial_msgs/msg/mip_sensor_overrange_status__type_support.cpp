...
static const _MipSensorOverrangeStatus_type_support_symbol_names_t _MipSensorOverrangeStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, microstrain_inertial_msgs, msg, MipSensorOverrangeStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, microstrain_inertial_msgs, msg, MipSensorOverrangeStatus)),
  }
};
...
{
  return &::microstrain_inertial_msgs::msg::rosidl_typesupport_cpp::MipSensorOverrangeStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, microstrain_inertial_msgs, msg, MipSensorOverrangeStatus)() {
  return get_message_type_support_handle<microstrain_inertial_msgs::msg::MipSensorOverrangeStatus>();
}
