...
static const _MipBaseDeviceInfo_type_support_symbol_names_t _MipBaseDeviceInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, microstrain_inertial_msgs, msg, MipBaseDeviceInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, microstrain_inertial_msgs, msg, MipBaseDeviceInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, microstrain_inertial_msgs, msg, MipBaseDeviceInfo)() {
  return &::microstrain_inertial_msgs::msg::rosidl_typesupport_c::MipBaseDeviceInfo_message_type_support_handle;
}
