...
bool microstrain_inertial_msgs__msg__mip_filter_aiding_measurement_summary__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("microstrain_inertial_msgs.msg._mip_filter_aiding_measurement_summary.MipFilterAidingMeasurementSummary", full_classname_dest, 102) == 0);
  }
  microstrain_inertial_msgs__msg__MipFilterAidingMeasurementSummary * ros_message = _ros_message;
  {  // header
  ...
  {  // indicator
    ...
    if (!microstrain_inertial_msgs__msg__mip_filter_aiding_measurement_summary_indicator__convert_from_py(field, &ros_message->indicator)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of MipFilterAidingMeasurementSummary */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("microstrain_inertial_msgs.msg._mip_filter_aiding_measurement_summary");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MipFilterAidingMeasurementSummary");
  ...
  {  // indicator
    PyObject * field = NULL;
    field = microstrain_inertial_msgs__msg__mip_filter_aiding_measurement_summary_indicator__convert_to_py(&ros_message->indicator);
    if (!field) {
      return NULL;
    }
    {
