...
bool microstrain_inertial_msgs__msg__mip_gnss_rf_error_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("microstrain_inertial_msgs.msg._mip_gnss_rf_error_detection.MipGnssRfErrorDetection", full_classname_dest, 82) == 0);
  }
  microstrain_inertial_msgs__msg__MipGnssRfErrorDetection * ros_message = _ros_message;
  {  // header
  ...
  {  // rf_band
    PyObject * field = PyObject_GetAttrString(_pymsg, "rf_band");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->rf_band = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // jamming_state
...
{
  /* NOTE(esteve): Call constructor of MipGnssRfErrorDetection */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("microstrain_inertial_msgs.msg._mip_gnss_rf_error_detection");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MipGnssRfErrorDetection");
  ...
  {  // rf_band
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->rf_band);
    {
      int rc = PyObject_SetAttrString(_pymessage, "rf_band", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
