...
bool microstrain_inertial_msgs__srv__raw_file_config_read__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("microstrain_inertial_msgs.srv._raw_file_config_read.RawFileConfigRead_Request", full_classname_dest, 77) == 0);
  }
  microstrain_inertial_msgs__srv__RawFileConfigRead_Request * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of RawFileConfigRead_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("microstrain_inertial_msgs.srv._raw_file_config_read");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RawFileConfigRead_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool microstrain_inertial_msgs__srv__raw_file_config_read__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("microstrain_inertial_msgs.srv._raw_file_config_read.RawFileConfigRead_Response", full_classname_dest, 78) == 0);
  }
  microstrain_inertial_msgs__srv__RawFileConfigRead_Response * ros_message = _ros_message;
  {  // enable
...
{
  /* NOTE(esteve): Call constructor of RawFileConfigRead_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("microstrain_inertial_msgs.srv._raw_file_config_read");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RawFileConfigRead_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
