...
#ifndef MICROSTRAIN_INERTIAL_MSGS__MSG__DETAIL__MIP_FILTER_GNSS_POSITION_AIDING_STATUS__STRUCT_H_
#define MICROSTRAIN_INERTIAL_MSGS__MSG__DETAIL__MIP_FILTER_GNSS_POSITION_AIDING_STATUS__STRUCT_H_
...
/// Struct defined in msg/MipFilterGnssPositionAidingStatus in the package microstrain_inertial_msgs.
/**
 ...
 */
typedef struct microstrain_inertial_msgs__msg__MipFilterGnssPositionAidingStatus
{
  ...
  microstrain_inertial_msgs__msg__MipFilterGnssPositionAidingStatusStatus status;
} microstrain_inertial_msgs__msg__MipFilterGnssPositionAidingStatus;

// Struct for a sequence of microstrain_inertial_msgs__msg__MipFilterGnssPositionAidingStatus.
typedef struct microstrain_inertial_msgs__msg__MipFilterGnssPositionAidingStatus__Sequence
{
...
#endif  // MICROSTRAIN_INERTIAL_MSGS__MSG__DETAIL__MIP_FILTER_GNSS_POSITION_AIDING_STATUS__STRUCT_H_
